...
class LoginMarchandScreen extends StatefulWidget {
  @override
  _LoginMarchandScreenState createState() => _LoginMarchandScreenState();
}

class _LoginMarchandScreenState extends State<LoginMarchandScreen> {
  ...
  Future signIn(BuildContext context) async {
    if (kIsWeb) {
      setState(() async {
        ...
        dynamic result  = await _auth.connectInWithEmailAndPassword(email, password);
        if(result==null){
          setState(() {
            loading = false;
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            elevation: 0.1,
            title: Text("Espace Marchand", style: TextStyle(fontFamily: "WorkSans",
