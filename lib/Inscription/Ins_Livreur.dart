...
class InscritLivreur extends StatefulWidget {
  @override
  _InscritLivreurState createState() => _InscritLivreurState();
}

class _InscritLivreurState extends State<InscritLivreur> {
      ...
      appBar: PreferredSize(
        ...
        child: Container(
          ...
          child: AppBar(
            ...
            elevation: 0.1,
            title: Text("Création de Compte Livreur", style: TextStyle(fontFamily: "WorkSans",
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                      ...
                                      validator: (value) =>value.isEmpty?
                                      "Veuillez entrer votre lieu d'habitation":null,
                                      keyboardType:TextInputType.text,
                                      decoration: buildInputDecoration(Icons.location_on, 'Lieu d\'habitation')
                                  ),
                                ),
                                SizedBox(
                                  height: 10,
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: () async{
                                      ...
                                      if(_formkey.currentState.validate()){
                                        ...
                                        dynamic result  = await _auth.registerWithEmailAndPassword(nom, email, lieu, numero, password);
                                        if(result==null){
                                          setState(() {
                                            loading = false;
